...
public class LutParametrosDataManager() : LutParametrosAbstract()
{
...
//		}
		...
		//GetListBy: *Nuevo Metodo* Devuelve lo mismo que el metodo GetBy, pero parseado a una lista de LutParametrosModel

//		public List<LutParametrosModel> GetListByParam1ParamNull2(int param1, int? paramNull2)
//		{
//			return this.GetByParam1ParamNull2Async(param1, paramNull2).Tables[0].Rows.Cast<DataRow>().Select(row => new LutParametrosModel(row)).ToList();
